...
public class SetAudition extends Fragment {
    ...
    Button saveAudition;
    EditText eventName, eventVenue, startTime, endTime, eventDate;
    Bitmap bitmap;
    Context context;
    ...
    public View onCreateView(@NonNull @NotNull LayoutInflater inflater, @Nullable @org.jetbrains.annotations.Nullable ViewGroup container, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_add_auditions, container, false);
    }
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        saveAudition = view.findViewById(R.id.saveEvent);
        ...
        saveAudition.setOnClickListener(v -> uploadEvent());
    }
    ...
    private void uploadEvent() {
        ...
        UploadEventsAsync uploadEventsAsync = new UploadEventsAsync(imageString, eveName, eveVenue, eveStartTime, eveEndTime, eveDate);
    ...
    class UploadEventsAsync extends AsyncTask<Void, Void, String> {
        ...
        private String imageStr, eName, eVenue, eStartT, eEndT, eDate;

        public UploadEventsAsync(String imageStr, String eName, String eVenue, String eStartT, String eEndT, String eDate) {
        ...
        protected String doInBackground(Void... voids) {
            ...
            return requestHandler.sendPostRequest(URLs.URL_ADD_AUDITION, params);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (!jsonObject.getBoolean("error")) {
                    ...
                    startActivity(new Intent(getContext(), Auditions.class));
